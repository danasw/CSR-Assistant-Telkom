...
public class CabutAddOnActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        instruksiList.add(new Instruksi("1. BUKA STARCLIK", "-Buka Starclick \n\n" +
                ...
                "-Contoh: PL85962;PAK XXX;0812XXXXXXXX;INXXXXXXXX;CABUT ADD ON XXXX;BY XXX \n\n" +
                "-Next \n\n"));
        instruksiList.add(new Instruksi("2. PILIH ADD ON", "-Pada Data Pelanggan Pilih Add On yang ingin dilepas \n\n" +
        ...
        instruksiList.add(new Instruksi("3. KEMBALI KE NOSSA", "-Pergi ke Work Logs > Isi Summary dan Details \n\n" +
                "-Contoh Summary: Sudah Proses Cabut Add On XXXX dengan SC XXXXXXXX, Details boleh diisi sama dengan Summary apabila tidak ada informasi tambahan \n\n" +
                "-Save dengan menekan Icon Disket di bagian atas \n\n" +
                "-Pergi ke Tab Actual Resolution \n\n" +
                "-Pada Actual Solution, tekan icon kaca pembesar, pada Decription ketik \"LAYANAN\", tekan Enter, Pilih SOLUTION_IPTV,IPTV - PAKET LAYANAN,PENCABUTAN LAYANAN - PAKET LAYANAN \n\n" +
