...
class CabutAddOnActivity : AppCompatActivity() {
    ...
    private val dummyDataToPass: ArrayList<Instruksi>
        get() {
            ...
            childInstruksi = ChildInstruksi()
            childInstruksi.isiInstruksi = "- Contoh: PL85962;PAK XXX;0812XXXXXXXX;INXXXXXXXX;CABUT ADD ON XXXX;BY XXX"
            childDataItems.add(childInstruksi)
            ...
            childDataItems = ArrayList()
            childInstruksi = ChildInstruksi()
            childInstruksi.isiInstruksi = "- Pada Data Pelanggan Pilih Add On yang ingin dilepas"
            childDataItems.add(childInstruksi)
