...
public class TambahAddOnActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = TambahAddOnActivity.this;
    ...
    private ArrayList<Instruksi> getDummyDataToPass() {
        ...
        childInstruksi = new ChildInstruksi();
        childInstruksi.setIsiInstruksi("- Contoh: PL85962;PAK XXX;0812XXXXXXXX;INXXXXXXXX;TAMBAH ADD ON XXXX;BY XXX");
        childDataItems.add(childInstruksi);
        ...
        /*UNTUK HEAD INSTRUKSI*/
        instruksi = new Instruksi();
        instruksi.setInstruksi("2. PILIH PAKET");
        childDataItems = new ArrayList<>();

        /*UNTUK ISI*/
        childInstruksi = new ChildInstruksi();
        childInstruksi.setIsiInstruksi("- Pilih Paket UseeTV, Perangkat IPTV, dan Tagihan yang sesuai ");
        childDataItems.add(childInstruksi);

        childInstruksi = new ChildInstruksi();
        childInstruksi.setIsiInstruksi("- Pada Add Ons, pilih salah satu Add Ons yang berhubungan dengan UseeTV sesuai keinginan pelanggan (USEETV ADD ON INDIHOME, ADD ON MINIPACK USEETV KHUSUS APARTEMENT, dll), \n" +
