...
public class BedaPaketUpgradeActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private Context mContext;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_upgrade_beda);
        mContext = BedaPaketUpgradeActivity.this;
        mRecyclerView = findViewById(R.id.recview_beda);
