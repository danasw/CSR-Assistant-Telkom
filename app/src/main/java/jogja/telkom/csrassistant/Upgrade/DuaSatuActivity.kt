...
class DuaSatuActivity : AppCompatActivity() {
    ...
    private val dummyDataToPass: ArrayList<Instruksi>
        get() {
            ...
            childInstruksi = ChildInstruksi()
            childInstruksi.isiInstruksi = "Pada Actual Solution, tekan icon kaca pembesar, pada Decription ketik \"migrasi\", tekan Enter, Pilih SOLUTION_INTERNET,INTERNET SAN,MIGRASI"
            childDataItems.add(childInstruksi)
